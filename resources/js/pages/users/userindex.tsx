...
/>
                                                ...
                                                {/* Column 6: Row actions (horizontal three dots, fixed at end, hover-revealed, requires delete.user permission) */}
                                                <td className="pe-6 text-end" onClick={(e) => e.stopPropagation()}>
                                                    {auth?.permissions?.includes('delete.user') && !user.is_protected && (
                                                        <div className="dropdown d-inline-block">
                                                            <a
                                                                href="javascript:void(0)"
                                                                className="text-muted action-trigger d-inline-flex align-items-center justify-content-center rounded-2"
                                                                id={`user-actions-${user.id}`}
                                                                data-bs-toggle="dropdown"
                                                                aria-expanded="false"
                                                                style={{ width: 32, height: 32 }}
                                                            >
                                                                <iconify-icon icon="solar:menu-dots-bold" className="fs-5" />
                                                            </a>
