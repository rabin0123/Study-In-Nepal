...
// TypeScript declaration to allow the <iconify-icon> custom web component element
declare global {
    namespace JSX {
...
export default function Register({ passwordRules }: Props) {
    ...
    return (
        <div 
            className="position-fixed top-0 start-0 end-0 bottom-0 d-flex bg-white" 
            style={{ zIndex: 999, fontFamily: "'Rajdhani', sans-serif" }}
        >
            ...
            <style>
                {`
                    ...
                    /* Custom hover state for standard Bootstrap linkages */
            ...
            <div className="container-fluid p-0 m-0 w-100 h-100">
                <div className="row g-0 h-100">
                    {/* ── Left Panel ── */}
                    <div 
                        className="col-lg-5 d-none d-lg-flex flex-column justify-content-center position-relative overflow-hidden" 
                        style={{
                    ...
                    >
                        ...
                        <div className="position-relative z-3 w-100 mx-auto text-center" style={{ maxWidth: '440px' }}>
                            ...
                            <p className="m-0" style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.95rem", fontWeight: "600", lineHeight: 1.8, letterSpacing: "0.08em" }}>
                    ...
                    {/* ── Right Panel ── */}
                    <div className="col-lg-7 col-12 d-flex align-items-center justify-content-center p-4 p-sm-5 overflow-y-auto" style={{ background: SURFACE }}>
                        <div className="w-100 my-auto" style={{ maxWidth: "512px" }}>
                            ...
                            <div className="d-lg-none text-center mb-4 mt-2">
                                ...
                                <h2 className="m-0" style={{ fontFamily: "'Castoro Titling', serif", fontSize: "2rem", color: DARK, textTransform: "uppercase" }}>Create Account</h2>
                            </div>

                            <div 
                                className="bg-white p-4 p-sm-5 rounded-4 border" 
                                style={{ 
                                            ...
                                            <div className="col-12 d-flex justify-content-center mt-4">
                                                <Button type="submit" tabIndex={7} disabled={processing} style={{
                                                    ...
                                                    <div style={{ width: 44, height: 44, borderRadius: "50%", border: "1.5px solid rgba(255,255,255,0.4)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                        {processing ? (
                                                            <iconify-icon icon="svg-spinners:180-ring" style={{ fontSize: '20px', color: '#fff' }}></iconify-icon>
                                                        ) : (
                                                            <iconify-icon icon="lucide:arrow-right" style={{ fontSize: '20px', color: '#fff' }}></iconify-icon>
                                                        )}
                                                    </div>
                                                </Button>
                                            </div>
                            ...
                            <div className="text-center mt-4 pb-4 text-secondary fw-semibold" style={{ fontSize: '0.95rem' }}>
                                Already registered an agency?{' '}
                                <TextLink href={login()} tabIndex={8} style={{ color: PRIMARY, fontWeight: "700" }} className="text-decoration-none text-link-hover">
                                    Log in here
                                </TextLink>
                            </div>
                        </div>
