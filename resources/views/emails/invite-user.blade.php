...
<div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
    An account has been created for you on the Study in Nepal Partner Portal — set your password to get started.
</div>
        ...
        <tr>
            <td class="fluid-padding" style="padding: 40px 48px 16px 48px; font-family:Arial, Helvetica, sans-serif;">
                ...
                <p style="margin:0 0 28px 0; font-size:15px; line-height:1.7; color:#4b5563;">
                    An account has been created for you on the <strong style="color:#0a0a0a;">Study in Nepal Partner Portal</strong>.
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.6; color:#9ca3af;">
                    This link will expire in {{ $expireMinutes ?? 60 }} minutes.
                </p>
