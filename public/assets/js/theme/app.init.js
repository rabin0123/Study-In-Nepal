...
// ── Theme persistence ────────────────────────────────────────────────
// Override the static default above with whatever the user last picked,
// so a refresh keeps the theme instead of always resetting to "light".
try {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleTheme() {
    ...
    // Persist the chosen theme so it survives a page refresh.
